...
class IndexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        list_students = [
            ...
            Student(2, "surname2", "name2", "patronymic2", "group2", 20),
            Student(3, "surname3", "name3", "patronymic3", "group2", 20),
            Student(4, "surname4", "name4", "patronymic4", "group1", 20),
            Student(5, "surname5", "name5", "patronymic5", "group1", 20),
            Student(6, "surname6", "name6", "patronymic6", "group3", 20),
            Student(7, "surname7", "name7", "patronymic7", "group3", 20),
            Student(8, "surname8", "name8", "patronymic8", "group2", 20),
            Student(9, "surname9", "name9", "patronymic9", "group1", 20),
            Student(10, "surname10", "name10", "patronymic10", "group1", 20),
        ]
